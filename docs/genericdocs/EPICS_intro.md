...
-   Channel Access or [pvAccess](inv:pvxs:overview): The interface between the external world and the IOC.
...
e.g. ai ( [Analog Input](inv:manual/aiRecord) ), ao (
[Analog Output](inv:manual/aoRecord) )), etc.
